                ...
                child: ConstrainedBox(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      ...
                      Auth().hematology( controllerSurgeries.text, controllerNewProblem.text, controllerSymptoms.text, controllerMedications.text);

                      if(!globals.MyRecords.contains("Hematology")){
                        setState(() {
                          globals.MyRecords.add("Hematology");
                        });
                      }

                      String car = "Hematology";
