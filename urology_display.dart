...
class displayUrology extends StatelessWidget {
  ...
  Stream<QuerySnapshot> getUsersStreamSnapshots(BuildContext context) async* {
    ...
    yield* Firestore.instance.collection('Users').document(uid.uid).collection('Urology').snapshots();
  }
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Row(children: <Widget>[
                  ...
                  Text(
                    'Do you have any personal or family history \nof any of:',
  ...
  Future<void> _createPDF() async {
    ...
    page.graphics.drawString('Urology', PdfStandardFont(PdfFontFamily.helvetica, 25, style: PdfFontStyle.bold));
    ...
    //for checkboxes
    page.graphics.drawString('+ Personal/Family History - ', PdfStandardFont(PdfFontFamily.timesRoman, 15), bounds: const Rect.fromLTWH(0, 60, 0, 0));
    ...
    //heading
    page.graphics.drawString('Current Problems', PdfStandardFont(PdfFontFamily.timesRoman, 15, style: PdfFontStyle.bold), bounds: const Rect.fromLTWH(0, 200, 0, 0));
    //with heading start with (15,0,0,0)
    page.graphics.drawString('1. Problems/Complains : $controllerNewProblem', PdfStandardFont(PdfFontFamily.timesRoman, 12), bounds: const Rect.fromLTWH(15, 230, 0, 0));
    page.graphics.drawString('2. Symptoms : $controllerSymptoms', PdfStandardFont(PdfFontFamily.timesRoman, 12), bounds: const Rect.fromLTWH(15, 260, 0, 0));
    page.graphics.drawString('3. Treatment/Medications : $controllerMedications', PdfStandardFont(PdfFontFamily.timesRoman, 12), bounds: const Rect.fromLTWH(15, 290, 0, 0));

    List<int> bytes = document.save();
    document.dispose();

    Auth().saveAndLaunchFile(bytes, 'Urology.pdf');
  }
}
